...
) ENGINE = InnoDB AUTO_INCREMENT = 204 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '柠檬账号大师 - 账号表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 100 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '柠檬账号大师 - AES密钥表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of lam_aes_key
-- ----------------------------
INSERT INTO `lam_aes_key` VALUES (1, 'ApjfT/KhcswJvxeWbZ20sZwqekz6yYLB5Okrm/zEgBlj+4HK9kZYML+aoEDJpgmh', '0', '2023-04-07 09:01:49');
INSERT INTO `lam_aes_key` VALUES (2, 'ApjfT/KhcswJvxeWbZ20sZwqekz6yYLB5Okrm/zEgBlj+4HK9kZYML+aoEDJpgmh', '0', '2023-04-07 09:01:49');
